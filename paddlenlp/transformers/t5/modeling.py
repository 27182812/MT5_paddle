...
class T5Attention(nn.Layer):
    ...
    def forward(
        ...
        attn_output = unshape(
            paddle.matmul(attn_weights, value_states)
...
class T5Block(nn.Layer):
    ...
    def forward(
        ...
        if do_cross_attention:
            ...
            # clamp inf values to enable fp16 training
            if (
                hidden_states.dtype == paddle.float16
...
class T5PreTrainedModel(PretrainedModel):
    ...
    pretrained_resource_files_map = {
        "model_state": {
            "t5-small": "https://huggingface.co/junnyu/t5/resolve/main/t5/t5-small/model_state.pdparams",
            "t5-base": "https://huggingface.co/junnyu/t5/resolve/main/t5/t5-base/model_state.pdparams",
            "t5-large": "https://huggingface.co/junnyu/t5/resolve/main/t5/t5-large/model_state.pdparams"
        }
    }
...
class T5Stack(T5PreTrainedModel):
    def __init__(self, pd_config, embed_tokens=None):
        ...
        self.block = nn.LayerList(
            [
                T5Block(pd_config, has_relative_attention_bias=bool(i == 0))
...
class T5EncoderModel(T5PreTrainedModel):
    ...
    def forward(
        ...
        return_dict = (
            ...
            else self.t5.pd_config.use_return_dict
        )
