...
class T5Tokenizer(AlbertEnglishTokenizer):
    ...
    def decode(self, seq, skip_special_tokens=False, clean_up_tokenization_spaces=True):
        if hasattr(seq,"tolist"):
            seq = seq.tolist()
        text = self.convert_tokens_to_string(self.convert_ids_to_tokens(seq,skip_special_tokens=skip_special_tokens))
